	...
	EntityWeatherselectmenu = ig.Entity.extend({
		...
		draw: function() {
			...
			if (this.bDrawMenu == true) {
				...
				ig.game.font.draw(returnWeatherValue + ' selected!' + this.liveTimer.delta(), 2, 400);
			}
		...
		reportSelection: function() {
			...
			ig.game.theWeather.selectWeatherType(returnWeatherValue);
